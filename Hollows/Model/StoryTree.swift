...
class StoryTree : pageController {
    ...
    let lvl4_3 = Node(value: "You get flashbacks of your days in the academy. You spent countless hours preparing for a situation like this where you would have to engage the enemy, and everything you were taught about stealth. You call out to Deus \" Let us use the sequence from drill #49.\" \"On your lead!\" affirms Deus. The both of you quietly open your lockers, and sneak up behind the last Earthling in the enemy squad. You twist the neck without offering a window for resistance. Deus follows suit and takes out the other one. You equip the Earthlings' gear and join the remaining ones. You continue doing this until their numbers are down to the last four, and the one that seems like their leader catches wind of what is going on and just as he turns around you open fire and shred them to bits and pieces with your blasters. In the process they seem to have led you to a new hallway with an opening leading to a ginormous structure. It appears to be the remnants of your crashed ship. You enter the ship. You see the corpses of you crew. \"Looks like it is just the both of us that made it. All of the escape pods that we had for returning to their moon are broken too. Except one.\" Just as Deus finishes speaking, you hear the Earthlings approaching. You quickly shut the door. \"Lenny, you need to take the pod and leave. I promise I will find a way back to their Moon\" says Deus. Taking the pod seems like the impulsive and logical choice. You could get back up to rescue Lenny. On the other hand, you feel like you could easily take the Earthlings out because you now have access to all your weapons. However, scouting the planet is what you were sent here for, and your mission is still not a complete failure yet. You look at the cold faces of your buddies from the crew. You have to make one very critical decision that will be of great consequence.", lchoice: "Fight", rchoice: "Escape")
    
    let lvl4_4 = Node(value: " \"Deus, I think we should hide in here until things are a little quieter \" you whisper. Deus says that he is ready whenever you are. You patiently wait until you can no longer hear the marching of the Earthlings and decide to make a run for it. You choose to head in the general direction that the Earthlings were heading towards, believing that it will probably lead to somewhere you get geather some upgrades and maybe even find an exit. The trail seems to have led you to a new hallway with an opening leading to a ginormous structure. There was no mistaking it - it was your spaceship. Unfortunately, it wasn't the only thing in the room. There were snipers placed along the scaffolds surrounding the ship. You could hear a man yell out \"I knew you would eventually end up here! Get 'em boys!\" With that they shot a barrage of blasts towards you. Deus shields you from the shots. \"Lenny, you have to live, I did not get a chance to tell you everything that happened. Not about how I feel about you. About us. I am sorry.\" He has wry smile on his face as he closes his eyes. You are crestfallen. The only person you remember is dying right in front of you. In the moment, your life starts flashing before your eyes. How you and Deus first met in the academy. Your yearlong journey to Earth. How you joked about getting married when you returned. And, with that, you gave in. It was complete darkness followed by you joining Deus back in the icy Martian sands. It was the afterlife. You died.", lchoice: "", rchoice: "")
    
    let lvl5_1 = Node(value: "With tears in your eyes, you enter the escape pod. You yell out to Deus \"Don't you die! You can not die like this! You have to make it! I will be waiting for you.\" Just as the words left your mouth, you saw Deus getting sprayed with bullets and bombarded with the nastiest blasts. They have a look at his corpse and then at your bawling face. The escape pod just makes it in time to be out of their reach. It was going to be a long and lonely journey. You are overcome with grief, and have lost the will to live. You notice the pressure levels dropping. Your pod is malfunctioning. You, however, are not scared. You are at peace with yourself. You just want for it all to end. You should have had the courage to stand by his side until the end, but you can now join him in the afterlife. You close your eyes, and embrace the bad ending.", lchoice: "Run", rchoice: "Sneak")
    
    let lvl5_2 = Node(value: "\"Stand tall Deus! We don't even know if I'll be able to make it to their Moon. I am not going to let all of those years preparing for this moment go to waste. It is time to put all of that to use now.\" You and Deus position yourself on either corner of the ship's entrance, and start taking out the Earthlings one after the other with your blasters as they storm in to their deaths. They try throwing grenades at you, but Deus just kicks them right back and takes out a major chunk of their forces. They retreat to regroup. You and Deus dash towards the fallen Earthlings, switch your armor with theirs and run straight in the direction that the Earthlings went in. You blend into their ranks and follow them as they launch a second assault and march towards the ship. They are losing their minds when they find that the ship is empty, and their leader suggests the squadron searches outside since they might have managed to escape. You and Deus get to follow them to your exit. You are asked to split up and spread out. Deus and you head towards the mountains outside where you find a bunch of campers and ditch your Armor and bury it. You have fought valiantly and escaped. You are now working towards blending into the crowd outside.", lchoice: "", rchoice: "")
    
    let lvl5_3 = Node(value: "With tears in your eyes, you enter the escape pod. You yell out to Deus \"Don't you die! You can not die like this! You have to make it! I will be waiting for you.\" Just as the words left your mouth, you saw Deus getting sprayed with bullets and bombarded with the nastiest blasts. They have a look at his corpse and then at your bawling face. The escape pod just makes it in time to be out of their reach. It was going to be a long and lonely journey. You are overcome with grief, and have lost the will to live. You notice the pressure levels dropping. Your pod is malfunctioning. You, however, are not scared. You are at peace with yourself. You just want for it all to end. You should have had the courage to stand by his side until the end, but you can now join him in the afterlife. You close your eyes, and embrace the bad ending.", lchoice: "", rchoice: "")
